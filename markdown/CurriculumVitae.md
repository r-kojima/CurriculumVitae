...
1社目では、会員事業向けのポイントカードiOSアプリの新規開発を担当しました。クリーンアーキテクチャをベースにしたアーキテクチャを実践することで、メンテナンス性を意識した開発を進めました。
...
開発に加えて下記の経験があり、プロダクトを改善するための仕事を横断的に行ってきました。
- フロントエンドチームのリーダー（1年半程度）
- メンター（エンジニア未経験者含む3名）の経験
- ビジネスサイドやセールスサイドと協業し、要件設計や見積もり等
...
#### プロジェクト2：ポイントカードアプリ開発
| 項目 | 詳細 |
|---|---|
| 期間 | 2019年9月〜2020年1月 |
| 職種 | iOSエンジニア |
| 役割 | メンバー |
| 仕事内容 | ポイントカードアプリの新規開発 |
| チーム規模 | 5人 |
| プロジェクト詳細・担当業務・主な実績 | **▼担当業務**<br>- ポイントカードアプリのドメインモデリング・設計・実装・テスト |
| 利用技術 | iOS, UIKit |
...
プログラミング自体よりも、本当に解決したい課題に対して向き合うことを大切にしています。
...
機能の実装だけでなく、ユーザー視点とビジネス視点を理解した上でプロダクト開発を進めることで、より価値のあるサービス作りを実現できると考えています。

**エンジニア育成・メンター力**

エンジニア未経験メンバーの成長支援に力を入れています。

業界未経験でReactの知識が全くない状態のメンバーのメンターを担当し、1年半にわたって指導しました。技術的なサポートだけでなく、学習計画の策定、定期的な進捗確認、実務を通じた実践的なスキル習得の機会を提供しました。その結果、そのメンバーは中規模ベンチャー企業にエンジニアとして転職できるレベルまで成長できました。
